...
for ctr3 = 1:size(locxy, 1);
    ...
    im_mask_erode = bwmorph(im_fil, 'thin', 1);
...
% 
%     %Dilate 
%     im_mask_dil = imdilate(maskerode_lbl, strel('disk', 2));
% 
%     im_mask_dil(im_mask_dil==0)=lbloffset;
%     im_mask_dil(im_mask_dil<lbloffset)=locxy(ctr3,3);      %label the according to track list
% 
% 
% lblfinal(im_mask_dil==locxy(ctr3,3)) = locxy(ctr3,3);

% figure, imagesc(maskerode_lbl)
% figure, imagesc(im_mask_dil)
